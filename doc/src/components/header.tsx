        ...
        <Flex sx={{ alignItems: `center`, justifyContent: `space-between`, flexDirection: [`column`, `row`] }}>
          <Flex>
            ...
            <Flex sx={{ flexDirection: `column` }}>
              <Box sx={{ fontSize: 3, fontWeight: `semibold`, lineHeight: `25px` }}>React Awesome Loaders</Box>
              <Box sx={{ color: `dark` }}>by Ashutosh Hathidara</Box>
            </Flex>
          </Flex>
          <Flex sx={{ mt: [4, 0], alignItems: `center` }}>
            <a href="https://github.com/ashutosh1919/react-loaders" sx={{ variant: `buttons.secondary` }}>
              GitHub
            </a>
            <button
              type="button"

...
const BoxesLoader = ({
  ...
  return (
    <Container sizeMarginBottom={sizeMarginBottom} duration={duration} sizeBoxes={sizeBoxes} className={className}>
      ...
      <StyledBox duration={duration} colors={colors} sizeBoxes={sizeBoxes} animParams={animParams[1]} boxTransforms={boxTransforms[1]}>
      <StyledBoxDiv boxDivParams={boxDivParams[0]}></StyledBoxDiv>
        <StyledBoxDiv boxDivParams={boxDivParams[1]}></StyledBoxDiv>
        <StyledBoxDiv boxDivParams={boxDivParams[2]}></StyledBoxDiv>
        <StyledBoxDiv boxDivParams={boxDivParams[3]}></StyledBoxDiv>
      </StyledBox>
      <StyledBox duration={duration} colors={colors} sizeBoxes={sizeBoxes} animParams={animParams[2]} boxTransforms={boxTransforms[2]}>
      <StyledBoxDiv boxDivParams={boxDivParams[0]}></StyledBoxDiv>
        <StyledBoxDiv boxDivParams={boxDivParams[1]}></StyledBoxDiv>
        <StyledBoxDiv boxDivParams={boxDivParams[2]}></StyledBoxDiv>
        <StyledBoxDiv boxDivParams={boxDivParams[3]}></StyledBoxDiv>
      </StyledBox>
      <StyledBox duration={duration} colors={colors} sizeBoxes={sizeBoxes} animParams={animParams[3]} boxTransforms={boxTransforms[3]}>
      <StyledBoxDiv boxDivParams={boxDivParams[0]}></StyledBoxDiv>
        <StyledBoxDiv boxDivParams={boxDivParams[1]}></StyledBoxDiv>
        <StyledBoxDiv boxDivParams={boxDivParams[2]}></StyledBoxDiv>
        <StyledBoxDiv boxDivParams={boxDivParams[3]}></StyledBoxDiv>

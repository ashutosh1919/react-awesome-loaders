...
const WifiLoader = ({
  ...
  return (
      <ParentDiv background={background} paddingPassed={sizeParentPadding} className={className}>
    <StyledDiv id="wifi-loader" background={background} passedSize={sizePassed}>
      <StyledSVGOuter className="circle-outer" passedSize={sizeOuter} viewBox="0 0 86 86">
        <StyledSVGCircleOuterBack className="back" backColor={backColor} cx="43" cy="43" r="40"></StyledSVGCircleOuterBack>
        <StyledSVGCircleOuterFront className="front" frontColor={frontColor} cx="43" cy="43" r="40"></StyledSVGCircleOuterFront>
        {/* <circle className="new" cx="43" cy="43" r="40"></circle> */}
      </StyledSVGOuter>
      <StyledSVGMiddle className="circle-middle" passedSize={sizeMiddle} viewBox="0 0 60 60">
        <StyledSVGCircleMiddleBack className="back" backColor={backColor} cx="30" cy="30" r="27"></StyledSVGCircleMiddleBack>
        <StyledSVGCircleMiddleFront className="front" frontColor={frontColor} cx="30" cy="30" r="27"></StyledSVGCircleMiddleFront>
      </StyledSVGMiddle>
      <StyledSVGInner className="circle-inner" passedSize={sizeInner} viewBox="0 0 34 34">
        <StyledSVGCircleInnerBack className="back" backColor={backColor} cx="17" cy="17" r="14"></StyledSVGCircleInnerBack>
        <StyledSVGCircleInnerFront className="front" frontColor={frontColor} cx="17" cy="17" r="14"></StyledSVGCircleInnerFront>
      </StyledSVGInner>
      <StyledText textColor={textColor} frontColor={frontColor} passedSize={sizeText} passedMargin={sizeTextMargin} data-text={text}></StyledText>
    </StyledDiv>
    </ParentDiv>
  );
};
